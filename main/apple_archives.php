...
<div class="row">
    <div class="col-md-12 text-center">
        <h3 class="text-info text-uppercase animated pulse infinite slow">Apple Archives</h3>
    </div>
</div>
...
<input type="text" id="filterAppleArchiveType" class="form-control resetSearch">
</div>

<div class="col-md-1">
<a href="apple_archives" type="button" class="btn btn-outline-danger mt-md-4 mt-2">Reset</a>
</div>
...
<div class="row">
<div class="col-md-12">
<div class="table-responsive" id="showPCArchivesTable">
...
<tr class="text-center">
    ...
    <td><?= $row_archive["specify"]; ?></td>
    <td><?= $row_archive["service_unserviceable"]; ?></td>
    <td width="10%">
        <a href="#" type="button" class="btn btn-outline-success restore-apple" data-bs-toggle="modal" data-bs-target="#modalPCRestore" id="<?= $row_archive["id"]; ?>"><i class="fa-solid fa-plus"></i></a>
    </td>
</tr>
...
$totalPCRecords = $recordsArchiveManager->getAppleTotalRecordsCount();

$pageCount = ceil($totalPCRecords / $recordsPerPage);

$rec = $recordsArchiveManager->getAppleArchivesRecords($page, $recordsPerPage);

$recordArchiveView = new ViewArchivesPC($rec);
