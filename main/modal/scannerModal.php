...
<input type="submit" class="btn btn-outline-primary btn-sm" name="btnScannerInsert" value="Add">
</div>
...
<input type="hidden" id="updateScannerId" name="updateScannerId">
...
<div class="col-md-12 mb-3 text-end">
<input type="submit" class="btn btn-outline-primary btn-sm" name="btnScannerUpdate" value="Update">
</div>
...
<div class="modal-body">
<h3>The <i><span id="del-Scanneredata" class="text-danger text-decoration-none"></span></i> records of <i><span id="del-Scanneredatauser" class="text-danger text-decoration-none"></span></i> will be deleted?</h3>
<form class="row" method="POST" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
<input type="hidden" name="del_scannerId" id="del_scannerId">
<div class="col-md-12 text-end">
	<input type="submit" class="btn btn-outline-danger btn-sm" name="btnDeleteScanner" value="Delete">
</div>
</form>
...
<div class="modal-body">
<h3>The <i><span id="restore-Scannerdata" class="text-success text-decoration-none"></span></i> of <i><span id="restore-ScannerTag" class="text-success text-decoration-none"></span></i> records will be Restored?</h3>
<form class="row" method="POST" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
<input type="hidden" name="restore_scannerId" id="restore_scannerId">
<div class="col-md-12 text-end">
	<input type="submit" class="btn btn-outline-success btn-sm" name="btnScannerRestore" value="Restore">
</div>
</form>
