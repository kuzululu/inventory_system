...
<input type="submit" class="btn btn-outline-primary btn-sm" name="btnAppleInsert" value="Add">
</div>
...
<input type="hidden" id="updateAppleId" name="updateApple_id">
...
<div class="col-md-12 mb-3 text-end">
<input type="submit" class="btn btn-outline-primary btn-sm" name="btnAppleUpdate" value="Update">
</div>
...
<div class="modal-body">
<h3>The <i><span id="del-Appledata" class="text-danger text-decoration-none"></span></i> records of <i><span id="del-Appledatauser" class="text-danger text-decoration-none"></span></i> will be deleted?</h3>
<form class="row" method="POST" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
<input type="hidden" name="deleteAppleId" id="delete_AppledataId">
<div class="col-md-12 text-end">
	<input type="submit" class="btn btn-outline-danger btn-sm" name="btnAppleDelete" value="Delete">
</div>
</form>
...
<div class="modal-body">
<h3>The <i><span id="restore-Appledata" class="text-success text-decoration-none"></span></i> of <i><span id="restore-appleTag" class="text-success text-decoration-none"></span></i> records will be Restored?</h3>
<form class="row" method="POST" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
<input type="hidden" name="restore_AppleId" id="restore_AppleId">
<div class="col-md-12 text-end">
	<input type="submit" class="btn btn-outline-success btn-sm" name="btnAppleRestore" value="Restore">
</div>
</form>
