...
<div class="row">
    <div class="col-md-12 text-center">
        <h3 class="text-info text-uppercase animated pulse infinite slow">Laptop Archives</h3>
    </div>
</div>
...
<input type="text" id="filterTypeArchLaptop" class="form-control resetSearch">
</div>
...
<tr class="text-center">
    ...
    <td width="10%">
        <a href="#" type="button" class="btn btn-outline-success restore-laptop" data-bs-toggle="modal" data-bs-target="#modalPCRestore" id="<?= $row_archive["id"]; ?>"><i class="fa-solid fa-plus"></i></a>
    </td>
</tr>
...
$totalPCRecords = $recordsArchiveManager->getLaptopTotalRecordsCount();

$pageCount = ceil($totalPCRecords / $recordsPerPage);

$rec = $recordsArchiveManager->getLaptopArchivesRecords($page, $recordsPerPage);
