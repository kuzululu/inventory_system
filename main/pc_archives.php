...
<div class="row">
    <div class="col-md-12 text-center">
        <h3 class="text-info text-uppercase animated pulse infinite slow">Computer Archives</h3>
    </div>
</div>
...
<input type="text" id="filterTypeArchive" class="form-control resetSearch">
</div>
...
<tr class="text-center">
    ...
    <td width="10%">
        <a href="#" type="button" class="btn btn-outline-success restore-pc" data-bs-toggle="modal" data-bs-target="#modalPCRestore" id="<?= $row_archive["id"]; ?>"><i class="fa-solid fa-plus"></i></a>
    </td>
</tr>
...
$totalPCRecords = $recordsArchiveManager->getTotalRecordsCount();

$pageCount = ceil($totalPCRecords / $recordsPerPage);

$rec = $recordsArchiveManager->getArchivesRecords($page, $recordsPerPage);
