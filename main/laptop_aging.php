...
<?php require_once "template-parts/laptop_quick_access.php"; ?>
    ...
    <div class="row mb-5">
    <div class="col-md-12">
      <button class="btn btn-primary btn-sm position-fixed" id="printLappyAging"><i class="fa-solid fa-print"></i></button>
    </div>
  </div>
    ...
    <div class="row">
          ...
          <?php
           ...
           ?>
            <div class="input-group">
              <select id="laptopAgeFilter" class="form-control resetSearch">
        ...
        <div class="col-md-3">
            <a href="laptop_aging" class="btn btn-outline-danger btn-sm mt-md-1 mt-3">Reset</a>
        </div>
...
<div class="table-responsive" id="showAgeLaptopData">
...
$recordsManager = new LaptopAgingManager($conn);
...
<div>
  <?php 
    $pcAge = new LaptopAgingManager($conn);
...
<script type="text/javascript" src="js/print-lappy.js"></script>
</body>
</html>
