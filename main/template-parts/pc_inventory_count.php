...
<div class="row">
<h3 class="h1-info text-center text-light h1-title">Computer Details</h3>
</div>
<div class="row">
		...
		<?php
			...
			$total = $totalRecordsCount->getTotalRecordsCount();
			echo "<h1 class='h1-info text-light'>".$total."</h1>";
		?>
		<small><a href="pc_summary" class="btn btn-sm btn-dark" type="button">View Details</a></small>
		</div>
		</div>
		<div class="col-md-4 text-center"></div>	
	</div>
	...
	<div class="row mt-3">
		...
		<div class="col-md-4 text-center info">
			...
			<?php
				...
				$total_unserviceRec = $unserviceRec->getTotalUnserviceable();
		...
		<div class="col-md-4 text-center info">
			...
			<?php
				...
				$total_serviceRec = $serviceRec->getTotalServiceable();
		...
		<div class="col-md-4 text-center info">
			...
			<div class="p-md-3">
			  <?php
				...
				$total_aging = $aging->getInventoryAging();
