...
<div class="row">
    <div class="col-md-12 text-center">
        <h3 class="text-info fw-bolder animated pulse slow infinite">PC Summary Report</h3>
    </div> <!-- end of row -->
</div>

<div class="row">
    <div class="col-md-12">
        <a target="_blank" href="?generate_pdf=true" class="btn btn-primary btn-sm position-fixed" id="printSummary"><i class="fa-solid fa-print"></i></a>
    </div>
</div> <!-- end of row -->
