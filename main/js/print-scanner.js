...
xhr.open("GET", "Apps/fetch_scanner.php", true);
...
if (xhr.status === 200) {
 try {
     ...
     let printArea = "<h2 class='text-center text-success'>Scanner Aging Records</h2>";
...
// trigger buttons
let btnPcAgingPrint = document.querySelector("#printScannerAging");
