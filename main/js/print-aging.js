...
xhr.open("GET", "Apps/fetch_aging_printRecords.php", true);
...
if (xhr.status === 200) {
 try {
     ...
     let printArea = "<h2 class='text-center text-success'>Computer Aging Records</h2>";
...
// trigger buttons
let btnPcAgingPrint = document.querySelector("#printAging");
