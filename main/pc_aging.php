...
<?php require_once "template-parts/pc_quick_access.php"; ?>
  ...
  <div class="row mb-5">
    <div class="col-md-12">
      <button class="btn btn-primary btn-sm position-fixed" id="printAging"><i class="fa-solid fa-print"></i></button>
    </div>
  </div>
    ...
    <div class="row">
          ...
          <?php
           ...
           ?>
            <div class="input-group">
              <select id="pcAgeFilter"class="form-control resetSearch">
        ...
        <div class="col-md-3">
            <a href="pc_aging" class="btn btn-outline-danger btn-sm mt-md-1 mt-3">Reset</a>
        </div>
...
$recordsManager = new PcAgingManager($conn);
...
<script type="text/javascript" src="js/print-aging.js"></script>
</body>
</html>
