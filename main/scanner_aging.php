...
<?php require_once "template-parts/scanner_quick_access.php"; ?>
    ...
    <div class="row mb-5">
      <div class="col-md-12">
        <button class="btn btn-primary btn-sm position-fixed" id="printScannerAging"><i class="fa-solid fa-print"></i></button>
      </div>
    </div>
    ...
    <div class="row">
          ...
          <?php
           ...
           ?>
            <div class="input-group">
              <select id="scannerAgeFilter" class="form-control resetSearch">
        ...
        <div class="col-md-3">
            <a href="scanner_aging" class="btn btn-outline-danger btn-sm mt-md-1 mt-3">Reset</a>
        </div>
...
<div class="table-responsive" id="showAgescannerData">
...
$recordsManager = new ScannerAgingManager($conn);
...
<div>
  <?php 
    $pcAge = new ScannerAgingManager($conn);
...
<script type="text/javascript" src="js/print-scanner.js"></script>
</body>
</html>
